...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final AIProvider _aiProvider = AIProvider(); // 使用工厂模式创建AIProvider
  ...
  void _handleSubmitted(String text) {
    ...
    _fetchReplyFromAI(text); // 使用工厂模式调用AIProvider的方法
  }

  void _fetchReplyFromAI(String message) {
    final ai = _aiProvider.getAI(); // 获取AI实例
    ai.fetchReply(message, (replyMessage) {
      setState(() {
...
class AIProvider {
  // 工厂方法，根据需要返回不同的AI实例
  AI getAI() {
    return ChatGPT(); // 这里可以根据需要返回不同的AI实例
  }
}

// AI接口
abstract class AI {
  void fetchReply(String message, void Function(String) onReply);
}

// ChatGPT实现AI接口
class ChatGPT implements AI {
  @override
  void fetchReply(String message, void Function(String) onReply) async {
